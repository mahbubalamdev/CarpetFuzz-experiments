...
if __name__ == "__main__":
    ...
    print("{:<20} {:<8} {:<8} {:<8} {:<8} {:<8} {:<8} {:<8} {:<8} {:<8} {:<8} {:<8} {:<8} {:<8} {:<8} {:<8} {:<8}".format('Average', '', '', '', "%.2f%%"%(r_sum["aflfast"] / 5), '', '', "%.2f%%"%(r_sum['mopt'] / 5), '', '', "%.2f%%"%(r_sum["afl++"] / 5), '', '', "%.2f%%"%(r_sum['carpetfuzz'] / 5), '', "%.2f%%"%(r_sum['all'] / 5), "%.2f%%"%(pct_sum / 5)))
